public abstract class HogwartsStudent {
    ...
    public void compareHogwarts(HogwartsStudent hogwartsStudent) {
        ...
        if (ability1 > ability2) {
            ...
            System.out.printf("Студент %s такой же,как студент %s:%d vs %d %n", hogwartsStudent.getName(), ability1, ability2);
        }
        }
        @Override
        public String toString () {
            return String.format("Студент %s ;сила магии :%d", name, magic, transgression);
        }
    }